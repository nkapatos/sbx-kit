...
| [shell-mise-docker](shell-mise-docker/) | `local/sbx-shell-mise-docker:latest` | `shell` | bake.env → shell-docker; workplace floor |
| [pi-mise-docker](pi-mise-docker/) | `local/sbx-pi-mise-docker:latest` | — | **Broken/parked** — Pi recipe stubbed |
| [hermes-mise-docker](hermes-mise-docker/) | `local/sbx-hermes-mise-docker:latest` | — | **Broken/parked** — Hermes recipe stubbed |
